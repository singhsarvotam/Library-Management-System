...
<center>
      <p><img src="../images/login/header.gif" width="538" height="85"></p>
        <h1><font size="+2"><b><img src="../images/login/login.gif" width="85" height="115"></b></font><br>
          <font color="RED">U had successful Logout....</font></h1>
        <h2>[<a href="../login/login.jsp">Login Again</a>] [<a href="../mainmenu/mainmenu.jsp">Main 
          Menu</a>]</h2>
      </center>
  </td>
  </tr>
