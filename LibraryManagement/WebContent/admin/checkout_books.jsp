...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="000000"> 
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;<a href="../mainmenu/mainmenu.jsp"><font color="ffffff">Home</font></a>
      ...
      width=1 border=0></TD>
    <td valign="top" width="100%" bgcolor="#f1f1f1" background="../images/booktwo.png"><center>

  <form name=checkout action="checkout_books_validate.jsp" method="post">
    <table width=225 border=0 cellpadding=3>
      ...
      <tr>
        <td><b>Branch_Id:<font color= "red">*</font></b></td>
        <td>
          <input type=text name="branch_id">
        </td>
      </tr>
      <tr>
        <td><b>Borrower's Card No.:<font color= "red">*</font></b></td>
        <td>
          <input type=text name="card_no">
        </td>
      </tr>
      <tr>
        <td><b>Date_Out:<font color= "red">*</font>(yyyy-mm-dd)</b></td>
        <td>
      ...
      <tr>
        <td colspan=2 align="center">
          <br><input type=submit value="Check Out Book(s)" name="checkout">
        </td>
