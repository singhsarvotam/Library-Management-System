...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="000000"> 
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;<a href="../mainmenu/mainmenu.jsp"><font color="ffffff">Home</font></a>
      ...
      width=1 border=0></TD>
    <td valign="top" width="100%" bgcolor="#f1f1f1" background=../images/login/addb.jpg><center>

  <form name=addborrower action="add_borrower_success.jsp" method="post">
    <table width=225 border=0 cellpadding=3>
      ...
      <tr>
      <br><br><br><br>
        <td><b>Ssn:<font color= "red">*</font></b></td>
        <td>
      ...
      <tr>
        <td colspan=2 align="center">
          <br><input type=submit value="Add Borrower" name="addBorrower">
        </td>
      </tr>
    </table>
  </form>
